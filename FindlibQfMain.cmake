...
if(NOT QFMAIN_INCLUDE_DIR)
	FIND_PATH(	QFMAIN_INCLUDE_DIR 
		NAMES qf_config.h
		PATHS ${CMAKE_CURRENT_LIST_DIR}/include/qfmain
	)
...
if(NOT QFMAIN_LIBRARY)
	FIND_LIBRARY(QFMAIN_LIBRARY 
	NAMES ${QFMAIN_LIBRARIES} 
	PATHS ${CMAKE_CURRENT_LIST_DIR}/lib/${CMAKE_BUILD_TYPE})
	message(${QFMAIN_LIBRARY})
endif()
