...
void MyStyle::polish(QPalette &palette)
{
	...
	QPixmap backgroundImage("G:/images/lightgreen.png");
	QPixmap buttonImage("G:/images/lightblue.png");
...
void MyStyle::setTexture(QPalette &palette, QPalette::ColorRole role,
